(function () {
    ...
    function populateData() {
      ...
      l.getDom('c_total').innerHTML = spraysInBag; // Wifi info

      l.getDom('wifi_ssid').value = params['ssid'];
      l.getDom('wifi_pass').value = params['pass'];
      l.getDom('has_wifi').innerHTML = params['has_wifi'] == '1' ? 'Connected to internet' : 'Not connected to internet'; // Other settings
